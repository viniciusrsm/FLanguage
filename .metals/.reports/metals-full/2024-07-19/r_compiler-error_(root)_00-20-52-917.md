...
### scala.reflect.internal.FatalError: 
  ThisType(method sla) for sym which is not a class
  ...
  last tree to typer: TypeTree(class IndexedStateT)
       tree position: line 12 of file:///C:/Users/Vinicius/UnB/FLanguage/src/main/scala/br/unb/cic/flang/MonadState.scala
            tree tpe: cats.data.State[br.unb.cic.flang.MonadState.package.S,A]
              symbol: class IndexedStateT in package data
   symbol definition: class IndexedStateT extends  (a ClassSymbol)
...
== Source file context for tree position ==
    ...
    10     }
    11 
    12     def sla[A] = State[S, A]{ state =>
    13         (state, s"The state is $state_CURSOR_")
    14     }
    15 
