...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Apply(macro method s)
       tree position: line 12 of file:///C:/Users/Vinicius/UnB/FLanguage/src/main/scala/br/unb/cic/flang/MonadState.scala
            tree tpe: String
              symbol: macro method s in class StringContext
   symbol definition: def s(args: Any*): String (a MethodSymbol)
      symbol package: scala
       symbol owners: macro method s -> class StringContext
...
== Source file context for tree position ==
    ...
    10 
    11     val teste: State[S, Strin_CURSOR_g] = State[M[Integer], String]{ state =>
    12         (state, s"The state is $state")
    13     }
    14 
    15     
...
package object MonadState {
    ...
    val teste: State[S, Strin@@g] = State[M[Integer], String]{ state =>
