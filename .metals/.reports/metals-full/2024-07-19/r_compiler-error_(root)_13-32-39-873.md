...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 17 of file:///C:/Users/Vinicius/UnB/FLanguage/src/main/scala/br/unb/cic/flang/MonadState.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
    ...
    14 IndexedStateT[Eval,IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],A]
    15     
    16     type S2[A] = IndexedStateT[Eval,IndexedStateT[Eval,S,S,A],IndexedStateT[Eval,S,S,A],String]
    17     val teste = State[S2[Integer], Intege_CURSOR_r]{ state =>
    18         (state, 0)
    19     }
    20     //teste.run()
...
IndexedStateT[Eval,IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],A]
    ...
    val teste = State[S2[Integer], Intege@@r]{ state =>
        (state, 0)
    }
    //teste.run()
