...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_A)
       tree position: line 14 of file:///C:/Users/Vinicius/UnB/FLanguage/src/main/scala/br/unb/cic/flang/MonadState.scala
            tree tpe: <error>
...
== Source file context for tree position ==
    ...
    11     //case class M[A](f: S => (S, A))
    12     
    13 IndexedStateT[Eval,IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],Integer]
    14 IndexedStateT[Eval,IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],_CURSOR_A]
    15     
    16     type S2[A] = IndexedStateT[Eval,IndexedStateT[Eval,S,S,A],IndexedStateT[Eval,S,S,A],String]
    17     val teste = State[S2[Integer], Integer]{ state =>
...
IndexedStateT[Eval,IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],IndexedStateT[Eval,IndexedStateT[Eval,S,S,Integer],IndexedStateT[Eval,S,S,Integer],String],Integer]
