...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_)
       tree position: line 13 of file:///C:/Users/Vinicius/UnB/FLanguage/src/main/scala/br/unb/cic/flang/MonadState.scala
            tree tpe: <error>
              symbol: value <error: <none>>
   symbol definition: val <error: <none>>: <error> (a TermSymbol)
      symbol package: br.unb.cic.flang.MonadState
       symbol owners: value <error: <none>> -> value <local package> -> package object MonadState
...
== Source file context for tree position ==
    ...
    13 _CURSOR_
    14     
    15     type S2[A] = IndexedStateT[Eval,IndexedStateT[Eval,S,S,A],IndexedStateT[Eval,S,S,A],String]
