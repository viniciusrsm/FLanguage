...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Apply(method apply)
       tree position: line 41 of file:///C:/Users/Vinicius/UnB/FLanguage/src/test/scala/br/unb/cic/flang/MonadTest.scala
...
class MonadTest extends AnyFlatSpec with should.Matchers {
  ...
  "eval CInt(5)" should "return an integer value 5." in {
    ...
    teste.run(eval(CInt(5), declarations = declarations))

    val (a, b) = teste.run(eval(CInt(5), declarations = List()))
