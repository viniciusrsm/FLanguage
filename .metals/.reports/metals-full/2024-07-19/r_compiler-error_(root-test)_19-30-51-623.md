...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(MonadState)
       tree position: line 18 of file:///C:/Users/Vinicius/UnB/FLanguage/src/test/scala/br/unb/cic/flang/MonadTest.scala
            tree tpe: br.unb.cic.flang.MonadState.type
              symbol: final package MonadState in package flang
   symbol definition: final package MonadState (a ModuleSymbol)
      symbol package: br.unb.cic.flang
       symbol owners: package MonadState
           call site: <none> in <none>

== Source file context for tree position ==

    15 
    16   val declarations = List(inc)
    17 
    18   val initialState: S = List()
    19 
    20    "pure should run and return 10" should "s" in {
    21   
...
class MonadTest extends AnyFlatSpec with should.Matchers {
  ...
  val initialState: S = List()
   ...
   "pure should run and return 10" should "s" in {
  
    val step1 = pure(10)
    val res = runState(pure)(initialState)
